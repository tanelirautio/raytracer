...
namespace rt {
	...
	Color Material::lighting(const PointLight& light, const Point& point, const Vector& eyev, const Vector& normalv) {
		...
		if (light_dot_normal < 0) {
			...
			if (reflect_dot_eye <= 0) {
				...
				auto factor = pow(reflect_dot_eye, m_shininess);
