...
namespace TestProject
{
	...
	public:
		...
		TEST_METHOD(Matrix_Calculate_Inverse)
		{
			std::vector<float> values_A = { 8, -5, 9, 2,
											7, 5, 6, 1,
											-6, 0, 9, 6,
											-3, 0, -9, -4 };			
			
			std::vector<float> values_B = { -0.15385f, -0.15385f, -0.28205f, -0.53846f,
		...
		TEST_METHOD(Matrix_Calculate_Inverse_2)
		{
			std::vector<float> values_A = { 9, 3, 0, 9,
											-5, -2, -6, -3,
											-4, 9, 6, 4,
											-7, 6, 6, 2 };			
